...
from transformers_neuronx.gemma.model import GemmaForSampling


class AEMGemmaForSampling(GemmaForSampling):
    ...
    def forward(self, input_ids, cache_ids=None, start_ids=None):
        ...
        # We need to also apply Gemma's LLM head as well
    ...
    def sample(self, input_ids, sequence_length, start_ids=None,
        ...
        # Change sample_gemma in sampling.py to use AEM LLMs <------------------
